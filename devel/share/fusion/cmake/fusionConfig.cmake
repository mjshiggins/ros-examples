...
if("TRUE" STREQUAL "TRUE")
  set(fusion_SOURCE_PREFIX /home/mac/Developer/ros-examples/src/fusion)
  set(fusion_DEVEL_PREFIX /home/mac/Developer/ros-examples/devel)
  set(fusion_INSTALL_PREFIX "")
  set(fusion_PREFIX ${fusion_DEVEL_PREFIX})
else()
  set(fusion_SOURCE_PREFIX "")
  set(fusion_DEVEL_PREFIX "")
  set(fusion_INSTALL_PREFIX /home/mac/Developer/ros-examples/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fusion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mac/Developer/ros-examples/src/fusion/${idir}'.  Ask the maintainer 'mac <mac@todo.todo>' to fix it.")
    endif()
